                ...
                if (cart != null) {
                    for (ProductDTO dto : cart.getCart().values()) {
                        if (dto.getProductID().equals(productID)) {
                            ...
                            float productPrice = dto.getProductPrice();
                            String productCategory = dto.getCategory();
                            String productImage = dto.getProductImage();
                            product = new ProductDTO(productID, productName, productPrice, productQuantity, productImage, productCategory, "", "", "");
