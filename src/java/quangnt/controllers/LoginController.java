...
public class LoginController extends HttpServlet {
    ...
    public static final String SUCCESS_USER = "user.jsp";
    public static final String SUCCESS_ADMIN = "admin.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user == null) {
                ...
                List<ProductDTO> list = productDAO.getListActiveProduct();
