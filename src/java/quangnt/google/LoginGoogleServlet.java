...
//            } else {
                ...
                userGG.setUserID(googlePojo.getId());
                userGG.setFullName(googlePojo.getEmail());
                userGG.setRoleID("US");
                userGG.setStatus("A");
                userGG.setPassword("1");
                session.setAttribute("LOGIN_USER", userGG);
                UserDAO dao = new UserDAO();
                if (dao.checkDuplicate(userGG) == false) {
                    dao.insertUserGG(userGG);
                }
//                request.setAttribute("userID", googlePojo.getId());
//                request.setAttribute("userName", googlePojo.getName());
